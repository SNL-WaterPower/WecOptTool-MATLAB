...
copyright = u'{} National Technology and Engineering Solutions of Sandia, LLC'.format(now.year)
author = u'unknown'
...
htmlhelp_basename = 'WecOptTool Documentation'
...
man_pages = [
    (master_doc, 'wecopttool-doc', u'WecOptTool Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wecopttool-doc', u'WecOptTool Documentation',
     author, 'wecopttool-doc', 'One line description of project.',
     'Miscellaneous'),
]
