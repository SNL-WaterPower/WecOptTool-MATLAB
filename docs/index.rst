...
The WEC Design Optimization MATLAB Toolbox (WecOptTool) allows users to perform wave energy converter (WEC) device design optimization studies while including different control strategies.
...
The developers would also like to acknowledge benefit from past collaborations with the `Oregon State University Design Engineering Lab`_.
...
.. _WaveBot: https://tethys-engineering.pnnl.gov/signature-projects/advanced-wec-dynamics-controls