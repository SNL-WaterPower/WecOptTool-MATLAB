...
classdef RM3DeviceModelParametricCCTest < matlab.unittest.TestCase
        ...
        function getPower(testCase)
            ...
            tempFixture = testCase.applyFixture(                    ...
             TemporaryFolderFixture(                                ...
                        ...
                        'WithSuffix', 'RM3DeviceModelParametricCCTest'));
            ...
            [testCase.WECpow,                                       ...
             testCase.etc] = RM3Device.getPower(tempFixture.Folder, ...
                                                S,                  ...
                                                'CC',               ...
                                                'parametric',       ...
                                                [10,15,3,42],   ...
    ...
    methods(Test)
        ...
        function test_existingRunFiles(testCase)
            ...
            tol = 5 * eps;
            madeFile = testCase.etc.hydro.rundir;
            RM3Device = WecOptLib.models.RM3.DeviceModel();
            [existpow,~] = RM3Device.getPower(madeFile,     ...
                                              testCase.SS,  ...
                                              'CC',         ...
                                              'existing',   ...
                                              madeFile);
